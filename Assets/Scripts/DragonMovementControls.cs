...
//     version 1.7.0
//     from Assets/Misc/DragonMovement 1.inputactions
//
...
public partial class @DragonMovementControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""FlyControls"",
                    ""type"": ""Value"",
                    ""id"": ""23d20384-cf35-4bcb-8df6-78fae4028bc7"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""UpDown"",
                    ""type"": ""Value"",
                    ""id"": ""330c1730-d2e3-47a3-b94a-841ccf9b5bd6"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""FlyControls"",
                    ""id"": ""c215fc52-ab4e-4570-a858-60d164eec1e8"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""3776df05-9ed6-485e-bd5f-2d680ea8ec1f"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""4ea59e50-f3a0-48d5-8e88-c18be35ef35e"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""757e3a9d-d13b-408b-9ffd-fc5664b555e4"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""2b3ed675-d7a3-43c8-b67f-935b7f7492bf"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""36f5e37d-b785-4f77-b261-056846c2351b"",
                    ""path"": ""1DAxis"",
                    ""interactions"": ""Hold"",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""b5ed8bc1-03a0-4c77-ad2f-62ffbd41bb59"",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""b3c6929e-5345-4df1-837d-af9b14369812"",
    ...
    ""controlSchemes"": [
        ...
        m_Movement_ChangeFly = m_Movement.FindAction("ChangeFly", throwIfNotFound: true);
        m_Movement_FlyControls = m_Movement.FindAction("FlyControls", throwIfNotFound: true);
    ...
    private readonly InputAction m_Movement_ChangeFly;
    private readonly InputAction m_Movement_FlyControls;
    ...
    public struct MovementActions
    {
        ...
        public InputAction @ChangeFly => m_Wrapper.m_Movement_ChangeFly;
        public InputAction @FlyControls => m_Wrapper.m_Movement_FlyControls;
        ...
        public void AddCallbacks(IMovementActions instance)
        {
            ...
            @ChangeFly.started += instance.OnChangeFly;
            @ChangeFly.performed += instance.OnChangeFly;
            @ChangeFly.canceled += instance.OnChangeFly;
            @FlyControls.started += instance.OnFlyControls;
            @FlyControls.performed += instance.OnFlyControls;
            @FlyControls.canceled += instance.OnFlyControls;
    ...
    public interface IMovementActions
    {
        ...
        void OnChangeFly(InputAction.CallbackContext context);
        void OnFlyControls(InputAction.CallbackContext context);
